...
class Quiz{
    ...
    public startQuiz() {
        ...
        if (this.quizType == 1){
            this.questionPopup = WA.ui.openPopup("question" + this.quizType + "Popup","Welchem Unternhemen gehörte das \n" +
    ...
    private nextQ(){
        ...
        if (this.currentQ == 12){
            this.questionPopup = WA.ui.openPopup("question"+this.quizType + "Popup","Was kann mit „publish“ \n" +
                ...
                "B:Entwickler können hiermit einen neuen Topic erstellen \n" +
                "und veröffentlichen \n \n" +
